...
class V1reconciliationsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\BulkSaleReportRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\SaleReportResponse
     */
    public function bulkSaleReport($body)
    {
        list($response) = $this->bulkSaleReportWithHttpInfo($body);
        return $response;
    }
     ...
     * Bulk reporting of sales
     *
     * @param  \Swagger\Client\Model\BulkSaleReportRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\SaleReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkSaleReportWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\SaleReportResponse';
        $request = $this->bulkSaleReportRequest($body);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\SaleReportResponse',
     ...
     */
    public function bulkSaleReportAsync($body)
    {
        return $this->bulkSaleReportAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkSaleReportAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\SaleReportResponse';
        $request = $this->bulkSaleReportRequest($body);
     ...
     */
    protected function bulkSaleReportRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling bulkSaleReport'
            );
        }
     ...
     * Report a sale
     *
     * @param  \Swagger\Client\Model\SaleReportRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\SaleReportResponse
     */
    public function saleReport($body)
    {
        list($response) = $this->saleReportWithHttpInfo($body);
        return $response;
    }
     ...
     * Report a sale
     *
     * @param  \Swagger\Client\Model\SaleReportRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\SaleReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function saleReportWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\SaleReportResponse';
        $request = $this->saleReportRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function saleReportAsync($body)
    {
        return $this->saleReportAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function saleReportAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\SaleReportResponse';
        $request = $this->saleReportRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function saleReportRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling saleReport'
            );
        }
