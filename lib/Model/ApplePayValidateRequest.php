 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplePayValidateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplePayValidateRequest';
     ...
     * Sets data
     *
     * @param string $data Encrypted payment data.
     *
     * @return $this
     */
     ...
     * Sets signature
     *
     * @param string $signature Signature of the payment and header data. The signature includes the signing certificate, its intermediate CA certificate, and information about the signing algorithm.
     *
     * @return $this
     */
     ...
     * Sets version
     *
     * @param string $version Version information about the payment token. The token uses `EC_v1` for ECC-encrypted data, and `RSA_v1` for RSA-encrypted data.
     *
     * @return $this
     */
