...
/**
 * ElvInitRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ElvInitRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ElvInitRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['mandate_text'] = isset($data['mandate_text']) ? $data['mandate_text'] : null;
    }
    ...
    {
        return $this->container['mandate_text'];
    }

    /**
     * Sets mandate_text
     *
     * @param string $mandate_text mandate_text
     *
     * @return $this
     */
    public function setMandateText($mandate_text)
    {
        $this->container['mandate_text'] = $mandate_text;
