...
/**
 * CardDetokenizeRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CardDetokenizeRequest extends DetokenizeRequest 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CardDetokenizeRequest';
     ...
     * Sets alias
     *
     * @param string $alias An alias received from a previous request.
     *
     * @return $this
     */
