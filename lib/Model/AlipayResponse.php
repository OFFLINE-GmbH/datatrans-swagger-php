...
class AlipayResponse implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['normal_url'] = isset($data['normal_url']) ? $data['normal_url'] : null;
    }
    ...
    {
        return $this->container['normal_url'];
    }

    /**
     * Sets normal_url
     *
     * @param string $normal_url The url used by the Mini APP in the payment confirmation process.
     *
     * @return $this
     */
    public function setNormalUrl($normal_url)
    {
        $this->container['normal_url'] = $normal_url;
