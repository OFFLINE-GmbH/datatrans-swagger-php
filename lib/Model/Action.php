...
class Action implements ModelInterface, ArrayAccess
{
    ...
    const ACTION_CHANGE_DETAILS = 'change_details';
     ...
     * Sets auto_settle
     *
     * @param bool $auto_settle Indicates if auto settlement was used. Only applicable if action was `authorize`
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param int $amount The amount used.
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param string $source From where the action originated.
     *
     * @return $this
     */
     ...
     * Sets date
     *
     * @param \DateTime $date Date when the action was performed.
     *
     * @return $this
     */
     ...
     * Sets success
     *
     * @param bool $success Whether the action was successful or not.
     *
     * @return $this
     */
     ...
     * Sets ip
     *
     * @param string $ip The IP address from where the action originated from.
     *
     * @return $this
     */
