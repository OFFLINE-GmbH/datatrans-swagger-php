 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AuthorizeError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthorizeError';
    ...
    protected static $swaggerTypes = [
        'code' => '\Swagger\Client\Model\TransactionsErrorCode',
        'message' => 'string',
        'start3_d_secure_url' => 'string'
    ];
    ...
    protected static $attributeMap = [
        'code' => 'code',
        'message' => 'message',
        'start3_d_secure_url' => 'start3DSecureUrl'
    ];
    ...
    protected static $setters = [
        'code' => 'setCode',
        'message' => 'setMessage',
        'start3_d_secure_url' => 'setStart3DSecureUrl'
    ];
    ...
    protected static $getters = [
        'code' => 'getCode',
        'message' => 'getMessage',
        'start3_d_secure_url' => 'getStart3DSecureUrl'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['start3_d_secure_url'] = isset($data['start3_d_secure_url']) ? $data['start3_d_secure_url'] : null;
    }
     ...
     * Gets code
     *
     * @return \Swagger\Client\Model\TransactionsErrorCode
     */
     ...
     * Sets code
     *
     * @param \Swagger\Client\Model\TransactionsErrorCode $code code
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message A human readable message indicating what went wrong.
     *
     * @return $this
     */
    ...
    /**
     * Gets start3_d_secure_url
     *
     * @return string
     */
    public function getStart3DSecureUrl()
    {
        return $this->container['start3_d_secure_url'];
    }

    /**
     * Sets start3_d_secure_url
     *
     * @param string $start3_d_secure_url start3_d_secure_url
     *
     * @return $this
     */
    public function setStart3DSecureUrl($start3_d_secure_url)
    {
        $this->container['start3_d_secure_url'] = $start3_d_secure_url;
