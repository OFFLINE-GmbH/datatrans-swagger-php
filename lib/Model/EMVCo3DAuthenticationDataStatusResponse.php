 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EMVCo3DAuthenticationDataStatusResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EMVCo3DAuthenticationDataStatusResponse';
     ...
     *
     * @param string $card_holder_info Text provided by the ACS/Issuer to Cardholder during a transaction that was not authenticated by the ACS. The Issuer can optionally provide information to Cardholder. For example, \"Additional authentication is needed for this transaction, please contact (Issuer Name) at xxx-xxx-xxxx.\"
     *
     * @return $this
     */
