 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MPXRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MPXRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['paycard'] = isset($data['paycard']) ? $data['paycard'] : null;
    ...
    {
        return $this->container['paycard'];
    }

    /**
     * Sets paycard
     *
     * @param string $paycard paycard
     *
     * @return $this
     */
    public function setPaycard($paycard)
    {
        $this->container['paycard'] = $paycard;
