 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CardInitThreeDSecure implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CardInitThreeDSecure';
    ...
    protected static $swaggerTypes = [
        'three_ds_requestor' => '\Swagger\Client\Model\ThreeDSRequestor',
        'three_ds_requestor_url' => 'string',
        'cardholder_account' => '\Swagger\Client\Model\CardholderAccount',
        'cardholder' => '\Swagger\Client\Model\Cardholder',
        'purchase' => '\Swagger\Client\Model\Purchase',
        'merchant' => '\Swagger\Client\Model\MerchantData',
        'broad_info' => 'string',
        'browser_information' => '\Swagger\Client\Model\Browser',
        'three_ri_ind' => 'string',
        'apply' => 'bool',
    ...
    const THREE_RI_IND__06 = '06';
    const THREE_RI_IND__07 = '07';
    const THREE_RI_IND__08 = '08';
    const THREE_RI_IND__09 = '09';
    const THREE_RI_IND__10 = '10';
    const THREE_RI_IND__11 = '11';
    const THREE_RI_IND__12 = '12';
    ...
    public function getThreeRiIndAllowableValues()
    {
        return [
            ...
            self::THREE_RI_IND__06,
            self::THREE_RI_IND__07,
            self::THREE_RI_IND__08,
            self::THREE_RI_IND__09,
            self::THREE_RI_IND__10,
            self::THREE_RI_IND__11,
            self::THREE_RI_IND__12,
        ];
    }
    ...
    {
        $this->container['three_ds_requestor'] = isset($data['three_ds_requestor']) ? $data['three_ds_requestor'] : null;
        $this->container['three_ds_requestor_url'] = isset($data['three_ds_requestor_url']) ? $data['three_ds_requestor_url'] : null;
        $this->container['cardholder_account'] = isset($data['cardholder_account']) ? $data['cardholder_account'] : null;
        ...
        $this->container['broad_info'] = isset($data['broad_info']) ? $data['broad_info'] : null;
        $this->container['browser_information'] = isset($data['browser_information']) ? $data['browser_information'] : null;
        $this->container['three_ri_ind'] = isset($data['three_ri_ind']) ? $data['three_ri_ind'] : null;
        $this->container['apply'] = isset($data['apply']) ? $data['apply'] : true;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['three_ri_ind']) && !in_array($this->container['three_ri_ind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'three_ri_ind', must be one of '%s'",
     ...
     *
     * @return \Swagger\Client\Model\ThreeDSRequestor
     */
     ...
     *
     * @param \Swagger\Client\Model\ThreeDSRequestor $three_ds_requestor three_ds_requestor
     *
     * @return $this
     */
     ...
     *
     * @param string $three_ds_requestor_url three_ds_requestor_url
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\CardholderAccount
     */
     ...
     *
     * @param \Swagger\Client\Model\CardholderAccount $cardholder_account cardholder_account
     *
     * @return $this
     */
     ...
     * Sets purchase
     *
     * @param \Swagger\Client\Model\Purchase $purchase purchase
     *
     * @return $this
     */
     ...
     * Gets merchant
     *
     * @return \Swagger\Client\Model\MerchantData
     */
     ...
     * Sets merchant
     *
     * @param \Swagger\Client\Model\MerchantData $merchant merchant
     *
     * @return $this
     */
     ...
     * Sets broad_info
     *
     * @param string $broad_info broad_info
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\Browser
     */
     ...
     *
     * @param \Swagger\Client\Model\Browser $browser_information browser_information
     *
     * @return $this
     */
     ...
     * Sets three_ri_ind
     *
     * @param string $three_ri_ind three_ri_ind
     *
     * @return $this
     */
     ...
     * Sets apply
     *
     * @param bool $apply Decides if the 3D secure process should be applied.
     *
     * @return $this
     */
     ...
     *
     * @param string $challenge_indicator challenge_indicator
     *
     * @return $this
     */
