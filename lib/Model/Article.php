...
class Article implements ModelInterface, ArrayAccess
{
     ...
     * Sets image_url
     *
     * @param string $image_url A https URL to the image of the article.
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param int $price The line item price including the VAT.
     *
     * @return $this
     */
     ...
     * Sets price_gross
     *
     * @param int $price_gross The article gross price including VAT.
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param int $quantity The number of similar articles on the current invoice line item.
     *
     * @return $this
     */
     ...
     * Sets tax
     *
     * @param int $tax This field is deprecated. Please use `taxAmount` for the tax amount and `taxPercent` for the tax rate.
     *
     * @return $this
     */
     ...
     * Sets tax_percent
     *
     * @param double $tax_percent The tax rate in percent [%].
     *
     * @return $this
     */
     ...
     * Sets tax_amount
     *
     * @param int $tax_amount The tax amount in the currency’s smallest unit. For example use 1000 for CHF 10.00.
     *
     * @return $this
     */
     ...
     *
     * @param int $price_without_vat The article price without VAT
     *
     * @return $this
     */
     ...
     * Sets discount
     *
     * @param int $discount The article discount.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The type of the article. Possible values vary per payment method.
     *
     * @return $this
     */
