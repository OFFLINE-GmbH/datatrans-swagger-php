...
/**
 * NetworkTokenOptions Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworkTokenOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NetworkTokenOptions';
    ...
    protected static $attributeMap = [
        'create_network_token' => 'createNetworkToken'
    ];
    ...
    protected static $setters = [
        'create_network_token' => 'setCreateNetworkToken'
    ];
    ...
    protected static $getters = [
        'create_network_token' => 'getCreateNetworkToken'
    ];
    ...
    {
        $this->container['create_network_token'] = isset($data['create_network_token']) ? $data['create_network_token'] : null;
    }
    ...
    /**
     * Gets create_network_token
     *
     * @return bool
     */
    public function getCreateNetworkToken()
    {
        return $this->container['create_network_token'];
    }

    /**
     * Sets create_network_token
     *
     * @param bool $create_network_token Create a Network Token.
     *
     * @return $this
     */
    public function setCreateNetworkToken($create_network_token)
    {
        $this->container['create_network_token'] = $create_network_token;
