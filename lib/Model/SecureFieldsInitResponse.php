 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SecureFieldsInitResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SecureFieldsInitResponse';
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id The `transactionId` to be used when calling SecureFields.init(). If no further action happens with the `transactionId` after initialization, it will be invalidated after 30 minutes.
     *
     * @return $this
     */
