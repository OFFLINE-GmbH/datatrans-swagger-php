...
/**
 * NetworkTokenCard Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworkTokenCard extends Card 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NetworkTokenCard';
    ...
    protected static $swaggerTypes = [
        ...
        'token_type' => 'string',
        'cryptogram' => 'string',
        '_3_d' => '\Swagger\Client\Model\NetworkToken3DAuthenticationData'
    ];
    ...
    const TYPE_NETWORK_TOKEN = 'NETWORK_TOKEN';
    const TYPE__DEFAULT = 'DEFAULT';
    const TOKEN_TYPE_VISA = 'VISA';
    const TOKEN_TYPE_MASTERCARD = 'MASTERCARD';
    ...
    {
        return [
            self::TOKEN_TYPE_VISA,
            self::TOKEN_TYPE_MASTERCARD,
        ];
    }
     ...
     * Sets token
     *
     * @param string $token Network token value.
     *
     * @return $this
     */
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month The expiry month of the network token.
     *
     * @return $this
     */
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year The expiry year of the network token.
     *
     * @return $this
     */
     ...
     * Sets token_type
     *
     * @param string $token_type The scheme which issued the network token.
     *
     * @return $this
     */
     ...
     * Sets cryptogram
     *
     * @param string $cryptogram The cryptogram needed for the network token authorization.
     *
     * @return $this
     */
     ...
     * Gets _3_d
     *
     * @return \Swagger\Client\Model\NetworkToken3DAuthenticationData
     */
     ...
     * Sets _3_d
     *
     * @param \Swagger\Client\Model\NetworkToken3DAuthenticationData $_3_d _3_d
     *
     * @return $this
     */
