...
/**
 * ResponseOverview Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResponseOverview implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseOverview';
     ...
     * Sets successful
     *
     * @param int $successful Successful requests.
     *
     * @return $this
     */
     ...
     * Sets failed
     *
     * @param int $failed Failed requests.
     *
     * @return $this
     */
