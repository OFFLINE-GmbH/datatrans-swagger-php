...
/**
 * KlarnaTrainInsurance Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KlarnaTrainInsurance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KlarnaTrainInsurance';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['insurance_type']) && !in_array($this->container['insurance_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'insurance_type', must be one of '%s'",
     ...
     *
     * @param double $insurance_price insurance_price
     *
     * @return $this
     */
