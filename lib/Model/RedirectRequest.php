 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RedirectRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RedirectRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['start_target'] = isset($data['start_target']) ? $data['start_target'] : null;
        $this->container['return_target'] = isset($data['return_target']) ? $data['return_target'] : null;
     ...
     * Sets success_url
     *
     * @param string $success_url The URL where the customer gets redirected to if the transaction was successful.
     *
     * @return $this
     */
     ...
     * Sets cancel_url
     *
     * @param string $cancel_url The URL where the customer gets redirected to if the transaction was canceled.
     *
     * @return $this
     */
     ...
     * Sets error_url
     *
     * @param string $error_url The URL where the customer gets redirected to if an error occurred.
     *
     * @return $this
     */
     ...
     * Sets start_target
     *
     * @param string $start_target If the payment is started within an iframe or when using the Lightbox Mode, use value `_top`. This ensures a proper browser flow for payment methods who need a redirect.
     *
     * @return $this
     */
     ...
     * Sets return_target
     *
     * @param string $return_target If the payment is started within an iframe or when using the Lightbox Mode, use `_top` if the redirect URLs should be opened full screen when payment returns from a 3rd party (for example 3D).
     *
     * @return $this
     */
