...
/**
 * NetworkTokenError Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworkTokenError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NetworkTokenError';
    ...
    const CODE_SERVICE_NOT_ALLOWED = 'SERVICE_NOT_ALLOWED';
    const CODE_INTERNAL_ERROR = 'INTERNAL_ERROR';
    const CODE_SCHEME_ERROR = 'SCHEME_ERROR';
    const CODE_DECLINED = 'DECLINED';
    const CODE_INVALID_TOKEN = 'INVALID_TOKEN';
    const CODE_ISSUER_ERROR = 'ISSUER_ERROR';
    ...
    {
        return [
            self::CODE_SERVICE_NOT_ALLOWED,
            self::CODE_INTERNAL_ERROR,
            self::CODE_SCHEME_ERROR,
            self::CODE_DECLINED,
            self::CODE_INVALID_TOKEN,
            self::CODE_ISSUER_ERROR,
