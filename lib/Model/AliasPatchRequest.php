...
/**
 * AliasPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AliasPatchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AliasPatchRequest';
    ...
    {
        $this->container['remove_plain'] = isset($data['remove_plain']) ? $data['remove_plain'] : null;
     ...
     * @return bool
     */
    public function getRemovePlain()
    {
        return $this->container['remove_plain'];
    }

    /**
     * Sets remove_plain
     *
     * @param bool $remove_plain Remove the pan from storage.
     *
     * @return $this
     */
    public function setRemovePlain($remove_plain)
    {
        $this->container['remove_plain'] = $remove_plain;
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year The expiry year of card.
     *
     * @return $this
     */
