...
/**
 * SwishRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SwishRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SwishRequest';
    ...
    protected static $attributeMap = [
        ...
        'payment_request_message' => 'paymentRequestMessage'
    ];
    ...
    protected static $setters = [
        'payer_alias' => 'setPayerAlias',
        'payment_request_message' => 'setPaymentRequestMessage'
    ];
    ...
    protected static $getters = [
        'payer_alias' => 'getPayerAlias',
        'payment_request_message' => 'getPaymentRequestMessage'
    ];
    ...
    {
        $this->container['payer_alias'] = isset($data['payer_alias']) ? $data['payer_alias'] : null;
        $this->container['payment_request_message'] = isset($data['payment_request_message']) ? $data['payment_request_message'] : null;
    }
    ...
    {
        return $this->container['payer_alias'];
    }

    /**
     * Sets payer_alias
     *
     * @param string $payer_alias The registered cellphone number of the person that makes the payment. It can only contain numbers and has to be at least 8 and at most 15 numbers. It also needs to match the following format in order to be found in Swish: country code + cellphone number (without leading zero). E.g.: 46712345678
     *
     * @return $this
     */
    public function setPayerAlias($payer_alias)
    {
        $this->container['payer_alias'] = $payer_alias;

        return $this;
    }

    /**
     * Gets payment_request_message
     *
     * @return string
     */
    public function getPaymentRequestMessage()
    {
        return $this->container['payment_request_message'];
    }

    /**
     * Sets payment_request_message
     *
     * @param string $payment_request_message Merchant supplied message about the payment/order. Max 50 characters. Common allowed characters are the letters a-ö, A-Ö, the numbers 0-9, and special characters !?=#$%&()*+,-./:;<'\"@. In addition, the following special characters are also allowed: ^¡¢£€¥¿Š§šŽžŒœŸÀÁÂÃÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕØØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõöøùúûüýþÿ
     *
     * @return $this
     */
    public function setPaymentRequestMessage($payment_request_message)
    {
        $this->container['payment_request_message'] = $payment_request_message;
