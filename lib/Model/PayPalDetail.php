 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PayPalDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayPalDetail';
     ...
     * Sets order_id
     *
     * @param string $order_id The PayPal orderId, if the transaction was a PayPal order.
     *
     * @return $this
     */
     ...
     * Sets payer_id
     *
     * @param string $payer_id The PayPal payerId
     *
     * @return $this
     */
