 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SecureFieldsUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SecureFieldsUpdateRequest';
     ...
     * Sets amount
     *
     * @param int $amount The newly to be used amount in the currency’s smallest unit. For example use 1000 for CHF 10.00.
     *
     * @return $this
     */
