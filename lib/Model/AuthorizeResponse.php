 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AuthorizeResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthorizeResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'card' => '\Swagger\Client\Model\AuthorizeCardDetail',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['acquirer_authorization_code'] = isset($data['acquirer_authorization_code']) ? $data['acquirer_authorization_code'] : null;
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id The transactionId to use for subsequent actions like settlement.
     *
     * @return $this
     */
     ...
     *
     * @param string $acquirer_authorization_code The authorization code returned by the acquirer or payment method provider.
     *
     * @return $this
     */
     ...
     * Gets card
     *
     * @return \Swagger\Client\Model\AuthorizeCardDetail
     */
     ...
     * Sets card
     *
     * @param \Swagger\Client\Model\AuthorizeCardDetail $card card
     *
     * @return $this
     */
