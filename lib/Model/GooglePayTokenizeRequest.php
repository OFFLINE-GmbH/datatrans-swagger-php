...
/**
 * GooglePayTokenizeRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GooglePayTokenizeRequest extends TokenizeRequest 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GooglePayTokenizeRequest';
     ...
     * Sets token
     *
     * @param string $token A wallet provider token containing encrypted card details.
     *
     * @return $this
     */
