 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ThreeRI implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ThreeRI';
    ...
    {
        $this->container['original_transaction_id'] = isset($data['original_transaction_id']) ? $data['original_transaction_id'] : null;
    }
     ...
     *
     * @param int $original_transaction_id original_transaction_id
     *
     * @return $this
     */
