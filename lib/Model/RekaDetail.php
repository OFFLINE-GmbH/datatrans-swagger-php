 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RekaDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RekaDetail';
     ...
     * Sets masked
     *
     * @param string $masked Masked REKA number. Can be used to display on a users profile page.
     *
     * @return $this
     */
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month The expiry month of the REKA card
     *
     * @return $this
     */
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year The expiry year of the REKA card
     *
     * @return $this
     */
     ...
     * Sets subtype
     *
     * @param string $subtype The REKA payment subtype. REK for REKA Pay, REL for REKA Lunch, RER for REKA Rail.
     *
     * @return $this
     */
