 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworkToken implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NetworkToken';
     ...
     * Sets token
     *
     * @param string $token Network token.
     *
     * @return $this
     */
     ...
     * Sets cryptogram
     *
     * @param string $cryptogram Cryptogram.
     *
     * @return $this
     */
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month Expiry month.
     *
     * @return $this
     */
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year Expiry year.
     *
     * @return $this
     */
