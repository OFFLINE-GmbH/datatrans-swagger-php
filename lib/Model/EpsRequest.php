 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EpsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EpsRequest';
    ...
    {
        $this->container['bankbic'] = isset($data['bankbic']) ? $data['bankbic'] : null;
        $this->container['order_info_text'] = isset($data['order_info_text']) ? $data['order_info_text'] : 'refno';
    }
     ...
     * Sets bankbic
     *
     * @param string $bankbic Identification of the customer’s (buyer’s) financial institution by a BIC.
     *
     * @return $this
     */
     ...
     *
     * @param string $order_info_text Text between the beneficiary/merchant and the buyer which will not be part of the payment instruction. If submitted, the final orderInfoText will be: `refno + ' ' + orderInfoText`
     *
     * @return $this
     */
