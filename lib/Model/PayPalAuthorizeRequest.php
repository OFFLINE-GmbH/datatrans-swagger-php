 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PayPalAuthorizeRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayPalAuthorizeRequest';
     ...
     *
     * @param string $order_transaction_id The transactionId of the order request executed previously, if this authorization is part of the order-authorize-capture (AC2) flow.
     *
     * @return $this
     */
