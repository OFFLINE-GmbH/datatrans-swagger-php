...
class AliasesErrorCode
{
     ...
     */
    const PLAIN_NOT_FOUND = 'PLAIN_NOT_FOUND';
    ...
    const COULD_NOT_OBTAIN_NETWORK_TOKEN = 'COULD_NOT_OBTAIN_NETWORK_TOKEN';
    const MAX_REQUESTS_PER_CALL_EXCEEDED = 'MAX_REQUESTS_PER_CALL_EXCEEDED';
    const VELOCITY_ERROR = 'VELOCITY_ERROR';
    const INVALID_PLAIN_VALUE = 'INVALID_PLAIN_VALUE';
    const INTERNAL_ERROR = 'INTERNAL_ERROR';
    const INVALID_JSON_PAYLOAD = 'INVALID_JSON_PAYLOAD';
    const SCHEME_ERROR = 'SCHEME_ERROR';
    const COULD_NOT_DECRYPT_TOKEN = 'COULD_NOT_DECRYPT_TOKEN';
    ...
    const ISSUER_ERROR = 'ISSUER_ERROR';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::UNAUTHORIZED
            self::COULD_NOT_OBTAIN_NETWORK_TOKEN
            self::MAX_REQUESTS_PER_CALL_EXCEEDED
            self::VELOCITY_ERROR
            self::INVALID_PLAIN_VALUE
            self::INTERNAL_ERROR
            self::INVALID_JSON_PAYLOAD
            self::SCHEME_ERROR
            self::COULD_NOT_DECRYPT_TOKEN
