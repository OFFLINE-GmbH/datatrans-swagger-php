...
/**
 * CustomDetokenizeResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomDetokenizeResponse extends DetokenizeResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomDetokenizeResponse';
     ...
     * Sets custom
     *
     * @param string $custom The detokenized plain value.
     *
     * @return $this
     */
