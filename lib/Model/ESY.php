 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ESY implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ESY';
     ...
     * Sets payment_info
     *
     * @param string $payment_info The payment info of the service (also known as billing text). NOTE: The paymentInfo will be placed on the end user invoice bill.
     *
     * @return $this
     */
     ...
     * Sets title
     *
     * @param string $title The title on top of the Swisscom Pay Payment Page.
     *
     * @return $this
     */
