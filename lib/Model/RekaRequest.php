 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RekaRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RekaRequest';
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month The expiry month of the Reka card alias.
     *
     * @return $this
     */
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year The expiry year of the Reka card alias
     *
     * @return $this
     */
