 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InitDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InitDetail';
     ...
     * Sets expires
     *
     * @param \DateTime $expires Tells when the initialized transaction will expire if not continued - 30 minutes after initialization.
     *
     * @return $this
     */
