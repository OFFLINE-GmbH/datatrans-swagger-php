...
class CustomerRequest implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['company_legal_form'] = isset($data['company_legal_form']) ? $data['company_legal_form'] : null;
     ...
     * Sets title
     *
     * @param string $title Something like `Ms` or `Mrs`
     *
     * @return $this
     */
     ...
     * Sets street2
     *
     * @param string $street2 Additional street information. For example: '3rd floor'
     *
     * @return $this
     */
     ...
     * Sets zip_code
     *
     * @param string $zip_code Zip code of the customer.
     *
     * @return $this
     */
     ...
     * Sets cell_phone
     *
     * @param string $cell_phone Cell Phone number of the customer.
     *
     * @return $this
     */
     ...
     * Sets gender
     *
     * @param string $gender Gender of the customer. `female` or `male`.
     *
     * @return $this
     */
     ...
     * Sets birth_date
     *
     * @param \DateTime $birth_date The birth date of the customer. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (`YYYY-MM-DD`).
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type `P` or `C` depending on whether the customer is private or a company. If `C`, the fields `name` and `companyRegisterNumber` are required
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of the company. Only applicable if `type=C`
     *
     * @return $this
     */
     ...
     *
     * @param string $company_legal_form The legal form of the company (AG, GmbH, ...)
     *
     * @return $this
     */
     ...
     *
     * @param string $company_register_number The register number of the company. Only applicable if `type=C`
     *
     * @return $this
     */
