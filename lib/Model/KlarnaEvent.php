 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KlarnaEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KlarnaEvent';
    ...
    protected static $swaggerTypes = [
        ...
        'company' => 'string',
        'genre' => 'string',
        'arena' => '\Swagger\Client\Model\KlarnaArena',
        'start' => '\DateTime',
        'end' => '\DateTime',
     ...
     * Sets company
     *
     * @param string $company The name of the company arranging the event.
     *
     * @return $this
     */
     ...
     * Sets genre
     *
     * @param string $genre The genre of the event.
     *
     * @return $this
     */
     ...
     * Gets arena
     *
     * @return \Swagger\Client\Model\KlarnaArena
     */
     ...
     * Sets arena
     *
     * @param \Swagger\Client\Model\KlarnaArena $arena arena
     *
     * @return $this
     */
     ...
     * Sets start
     *
     * @param \DateTime $start The start date and time of the event. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return $this
     */
     ...
     * Sets end
     *
     * @param \DateTime $end The end date and time of the event. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return $this
     */
     ...
     *
     * @param bool $access_controlled_venue Tickets are digitally checked when entering the venue.
     *
     * @return $this
     */
     ...
     *
     * @param string $ticket_delivery_method The ticket delivery method.
     *
     * @return $this
     */
     ...
     *
     * @param string $ticket_delivery_recipient The name of the recipient the ticket is delivered to. If the method isEMAIL or PHONE, use either the email address or the phone number.
     *
     * @return $this
     */
     ...
     * Sets affiliate_name
     *
     * @param string $affiliate_name The name of the affiliate that originated the purchase.
     *
     * @return $this
     */
