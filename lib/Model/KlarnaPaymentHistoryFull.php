 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KlarnaPaymentHistoryFull implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KlarnaPaymentHistoryFull';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['paid_purchases'] = isset($data['paid_purchases']) ? $data['paid_purchases'] : null;
        $this->container['total_amount_paid_purchases'] = isset($data['total_amount_paid_purchases']) ? $data['total_amount_paid_purchases'] : null;
        $this->container['last_paid_purchase'] = isset($data['last_paid_purchase']) ? $data['last_paid_purchase'] : null;
        $this->container['first_paid_purchase'] = isset($data['first_paid_purchase']) ? $data['first_paid_purchase'] : null;
    }
     ...
     *
     * @param string $unique_identifier Unique name or number to identify the specific customer account. Max. 24 characters.
     *
     * @return $this
     */
     ...
     * Sets payment_option
     *
     * @param string $payment_option The type of the line item
     *
     * @return $this
     */
     ...
     * Sets paid_purchases
     *
     * @param int $paid_purchases The total number of successful purchases.
     *
     * @return $this
     */
     ...
     *
     * @param double $total_amount_paid_purchases The total amount of successful purchases (in local currency).
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $last_paid_purchase The date and time of the last paid purchase. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $first_paid_purchase The date and time of the first paid purchase. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return $this
     */
