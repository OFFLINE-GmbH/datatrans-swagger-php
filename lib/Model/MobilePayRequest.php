...
/**
 * MobilePayRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MobilePayRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MobilePayRequest';
    ...
    protected static $swaggerTypes = [
        'mobile_pay_phone_number' => 'string'
    ];
    ...
    protected static $attributeMap = [
        'mobile_pay_phone_number' => 'mobilePayPhoneNumber'
    ];
    ...
    protected static $setters = [
        'mobile_pay_phone_number' => 'setMobilePayPhoneNumber'
    ];
    ...
    protected static $getters = [
        'mobile_pay_phone_number' => 'getMobilePayPhoneNumber'
    ];
    ...
    {
        $this->container['mobile_pay_phone_number'] = isset($data['mobile_pay_phone_number']) ? $data['mobile_pay_phone_number'] : null;
    }
    ...
    /**
     * Gets mobile_pay_phone_number
     *
     * @return string
     */
    public function getMobilePayPhoneNumber()
    {
        return $this->container['mobile_pay_phone_number'];
    }

    /**
     * Sets mobile_pay_phone_number
     *
     * @param string $mobile_pay_phone_number The registered cellphone number of the person that makes the payment. It can only contain numbers and has to be at least 8 and at most 15 numbers. It also needs to match the following format in order to be found in MobilePay: country code + cellphone number (without leading zero). E.g.: +4589371020
     *
     * @return $this
     */
    public function setMobilePayPhoneNumber($mobile_pay_phone_number)
    {
        $this->container['mobile_pay_phone_number'] = $mobile_pay_phone_number;
