...
class CardInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets brand
     *
     * @param string $brand The brand of the credit card (e.g. VISA CREDIT).
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The type of the card (`credit`, `debit` or `prepaid`). The property will not be present if the card type is unknown.
     *
     * @return $this
     */
     ...
     * Sets usage
     *
     * @param string $usage The usage of the card (`consumer`, `corporate` or `unknown`)
     *
     * @return $this
     */
     ...
     * Sets issuer
     *
     * @param string $issuer The issuer of the card
     *
     * @return $this
     */
