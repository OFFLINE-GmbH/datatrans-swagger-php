 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KlarnaSubscription implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KlarnaSubscription';
     ...
     * Sets name
     *
     * @param string $name The name of the product of the subscription
     *
     * @return $this
     */
     ...
     * Sets start
     *
     * @param \DateTime $start The start date and time of the subscription. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return $this
     */
     ...
     * Sets end
     *
     * @param \DateTime $end The end date and time of the subscription. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return $this
     */
     ...
     * Sets auto_renewal
     *
     * @param bool $auto_renewal `true` if the subscription will be auto renewed upon expiry.
     *
     * @return $this
     */
