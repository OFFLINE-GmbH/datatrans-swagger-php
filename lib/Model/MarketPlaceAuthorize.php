 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MarketPlaceAuthorize implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MarketPlaceAuthorize';
    ...
    protected static $swaggerTypes = [
        'splits' => '\Swagger\Client\Model\MarketPlaceSplit[]'
    ];
    ...
    {
        $this->container['splits'] = isset($data['splits']) ? $data['splits'] : null;
    }
     ...
     * Gets splits
     *
     * @return \Swagger\Client\Model\MarketPlaceSplit[]
     */
     ...
     * Sets splits
     *
     * @param \Swagger\Client\Model\MarketPlaceSplit[] $splits The marketplace splits
     *
     * @return $this
     */
