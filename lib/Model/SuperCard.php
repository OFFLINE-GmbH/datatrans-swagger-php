 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SuperCard implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SuperCard';
     ...
     * Sets subtype
     *
     * @param string $subtype The SCX payment subtype. SCM for Mastercard, SCV for Visa and SCP for Visa prepaid
     *
     * @return $this
     */
