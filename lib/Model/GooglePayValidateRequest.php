 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GooglePayValidateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GooglePayValidateRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'intermediate_signing_key' => '\Swagger\Client\Model\IntermediateSigningKey'
    ];
     ...
     * Sets signature
     *
     * @param string $signature Verifies that the message came from Google. It's Base64-encoded, and created with ECDSA by the intermediate signing key.
     *
     * @return $this
     */
     ...
     *
     * @param string $protocol_version Identifies the encryption or signing scheme under which the message was created. It allows the protocol to evolve over time, if needed.
     *
     * @return $this
     */
     ...
     * Sets signed_message
     *
     * @param string $signed_message A JSON object serialized as a string that contains the encryptedMessage, ephemeralPublicKey, and tag. It's serialized to simplify the signature verification process.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\IntermediateSigningKey
     */
     ...
     *
     * @param \Swagger\Client\Model\IntermediateSigningKey $intermediate_signing_key intermediate_signing_key
     *
     * @return $this
     */
