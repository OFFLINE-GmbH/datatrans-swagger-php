...
class OrderMetaData implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['related_order_reference_id'] = isset($data['related_order_reference_id']) ? $data['related_order_reference_id'] : null;
    }
     ...
     * Sets version
     *
     * @param string $version The version of OrderMetaData field (used for tracking schema changes to the field).
     *
     * @return $this
     */
     ...
     *
     * @param int $number_of_items The number of items that the order contains. For example, two cups of coffee.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Type of items. Physical, Digital, Mixed
     *
     * @return $this
     */
     ...
     *
     * @param string $related_order_reference_id Order ID of the related order. For the deposit this field will be empty, while for any subsequent payment related to the same booking this will be the order ID of the deposit transaction.
     *
     * @return $this
     */
