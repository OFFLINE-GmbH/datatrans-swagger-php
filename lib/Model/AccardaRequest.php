 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccardaRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccardaRequest';
    ...
    protected static $swaggerTypes = [
        'mode' => 'string',
        'installment' => '\Swagger\Client\Model\Installment',
        'channel' => 'string',
        'street_split' => 'bool',
        'screening_only' => 'bool',
        'order_number' => 'string',
        'coupon_amount' => 'int',
        'attachments' => '\Swagger\Client\Model\AccardaAttachment[]'
    ];
    ...
    {
        $this->container['mode'] = isset($data['mode']) ? $data['mode'] : 'invoice';
        $this->container['installment'] = isset($data['installment']) ? $data['installment'] : null;
        $this->container['channel'] = isset($data['channel']) ? $data['channel'] : null;
        $this->container['street_split'] = isset($data['street_split']) ? $data['street_split'] : false;
        $this->container['screening_only'] = isset($data['screening_only']) ? $data['screening_only'] : false;
     ...
     * Sets installment
     *
     * @param \Swagger\Client\Model\Installment $installment installment
     *
     * @return $this
     */
     ...
     * Sets channel
     *
     * @param string $channel The invoice channel
     *
     * @return $this
     */
     ...
     * Sets street_split
     *
     * @param bool $street_split If `true` the value of `customer.street` will be split into street nameand street number
     *
     * @return $this
     */
     ...
     * Sets screening_only
     *
     * @param bool $screening_only If `true` only a pre-screening request is done.
     *
     * @return $this
     */
     ...
     * Sets order_number
     *
     * @param string $order_number Accarda reference number, mainly useful for B2B orders where the company doing the order might have their own ID to identify the invoice later on within their own systems.
     *
     * @return $this
     */
     ...
     * Sets coupon_amount
     *
     * @param int $coupon_amount Amount in the basket payed by coupon or other payment instruments.
     *
     * @return $this
     */
     ...
     * Gets attachments
     *
     * @return \Swagger\Client\Model\AccardaAttachment[]
     */
     ...
     * Sets attachments
     *
     * @param \Swagger\Client\Model\AccardaAttachment[] $attachments List of base64 encoded attachments
     *
     * @return $this
     */
