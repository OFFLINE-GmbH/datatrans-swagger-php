 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AmazonPayRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AmazonPayRequest';
    ...
    protected static $swaggerTypes = [
        'seller_note' => 'string',
        'fraud_context' => '\Swagger\Client\Model\AmazonFraudContext'
    ];
    ...
    {
        $this->container['seller_note'] = isset($data['seller_note']) ? $data['seller_note'] : null;
        $this->container['fraud_context'] = isset($data['fraud_context']) ? $data['fraud_context'] : null;
    }
     ...
     * Sets seller_note
     *
     * @param string $seller_note Represents a description of the billing agreement that is shown in emails to the buyer and on the Amazon Pay website.
     *
     * @return $this
     */
     ...
     * Gets fraud_context
     *
     * @return \Swagger\Client\Model\AmazonFraudContext
     */
     ...
     * Sets fraud_context
     *
     * @param \Swagger\Client\Model\AmazonFraudContext $fraud_context fraud_context
     *
     * @return $this
     */
