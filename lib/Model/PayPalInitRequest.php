 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PayPalInitRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayPalInitRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'transaction_context' => '\Swagger\Client\Model\TransactionContext'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['display_shipping_details'] = isset($data['display_shipping_details']) ? $data['display_shipping_details'] : null;
        $this->container['forward_customer_details'] = isset($data['forward_customer_details']) ? $data['forward_customer_details'] : null;
        $this->container['return_customer_details'] = isset($data['return_customer_details']) ? $data['return_customer_details'] : null;
        $this->container['create_order'] = isset($data['create_order']) ? $data['create_order'] : null;
        $this->container['fraud_session_id'] = isset($data['fraud_session_id']) ? $data['fraud_session_id'] : null;
        $this->container['transaction_context'] = isset($data['transaction_context']) ? $data['transaction_context'] : null;
    }
     ...
     * Sets image_url
     *
     * @param string $image_url A https URL to the logo of the merchant.
     *
     * @return $this
     */
     ...
     *
     * @param bool $display_shipping_details Regulates whether the shipping details are displayed or not. (Note: `forwardCustomerDetails` and `displayShippingDetails` should be set to `no` if the shipping details should not be shown on the PayPal page.
     *
     * @return $this
     */
     ...
     *
     * @param bool $forward_customer_details `true` if the customer details (if submitted) should be forwarded to PayPal. Default is `false`.
     *
     * @return $this
     */
     ...
     *
     * @param bool $return_customer_details `true` if the customer details should be retrieved from PayPal.
     *
     * @return $this
     */
     ...
     * Sets create_order
     *
     * @param bool $create_order `true` if a PayPal AC2 order is to be created. Default is `false`.
     *
     * @return $this
     */
     ...
     *
     * @param string $fraud_session_id The PayPal FraudNet session identifier as specified in the API documentation.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\TransactionContext
     */
     ...
     *
     * @param \Swagger\Client\Model\TransactionContext $transaction_context transaction_context
     *
     * @return $this
     */
