...
class Leg implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'departure_time' => '\Swagger\Client\Model\LocalTime',
        'arrival_time' => '\Swagger\Client\Model\LocalTime',
        'class' => 'string'
    ];
     ...
     *
     * @param string $departure_airport The origin or departure airport code for this leg.
     *
     * @return $this
     */
     ...
     *
     * @param string $arrival_airport The destination or arrival airport code for this leg.
     *
     * @return $this
     */
     ...
     * Sets carrier
     *
     * @param string $carrier Carrier airline code(i.e.'OS')
     *
     * @return $this
     */
     ...
     * Sets fare_basis
     *
     * @param string $fare_basis Fare  basis (i.e. 'URRVP/OCF')
     *
     * @return $this
     */
     ...
     * Sets flight_number
     *
     * @param string $flight_number Flight number (i.e. OS 834)
     *
     * @return $this
     */
     ...
     * Sets flight_date
     *
     * @param \DateTime $flight_date Date of flight. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (`YYYY-MM-DD`).
     *
     * @return $this
     */
     ...
     * Gets departure_time
     *
     * @return \Swagger\Client\Model\LocalTime
     */
     ...
     * Sets departure_time
     *
     * @param \Swagger\Client\Model\LocalTime $departure_time departure_time
     *
     * @return $this
     */
     ...
     * Sets arrival_time
     *
     * @param \Swagger\Client\Model\LocalTime $arrival_time arrival_time
     *
     * @return $this
     */
     ...
     * Sets class
     *
     * @param string $class Class code (i.e.'U')
     *
     * @return $this
     */
