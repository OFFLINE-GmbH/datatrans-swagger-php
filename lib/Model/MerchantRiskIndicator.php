 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MerchantRiskIndicator implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MerchantRiskIndicator';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ship_indicator']) && !in_array($this->container['ship_indicator'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'ship_indicator', must be one of '%s'",
        ...
        if (!is_null($this->container['reorder_items_ind']) && !in_array($this->container['reorder_items_ind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'reorder_items_ind', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
        ...
        if (!is_null($this->container['pre_order_purchase_ind']) && !in_array($this->container['pre_order_purchase_ind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'pre_order_purchase_ind', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets ship_indicator
     *
     * @param string $ship_indicator ship_indicator
     *
     * @return $this
     */
     ...
     *
     * @param string $delivery_timeframe delivery_timeframe
     *
     * @return $this
     */
     ...
     *
     * @param string $delivery_email_address delivery_email_address
     *
     * @return $this
     */
     ...
     *
     * @param string $reorder_items_ind reorder_items_ind
     *
     * @return $this
     */
     ...
     *
     * @param string $pre_order_purchase_ind pre_order_purchase_ind
     *
     * @return $this
     */
     ...
     * Sets pre_order_date
     *
     * @param \DateTime $pre_order_date pre_order_date
     *
     * @return $this
     */
     ...
     *
     * @param int $gift_card_amount gift_card_amount
     *
     * @return $this
     */
     ...
     * Sets gift_card_curr
     *
     * @param string $gift_card_curr gift_card_curr
     *
     * @return $this
     */
     ...
     *
     * @param string $gift_card_count gift_card_count
     *
     * @return $this
     */
