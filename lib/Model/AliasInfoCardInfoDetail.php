...
/**
 * AliasInfoCardInfoDetail Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AliasInfoCardInfoDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AliasInfoCardInfoDetail';
    ...
    protected static $swaggerTypes = [
        ...
        '_3_d' => '\Swagger\Client\Model\ThreeDInfo',
    ...
    {
        $this->container['pan_removed'] = isset($data['pan_removed']) ? $data['pan_removed'] : null;
     ...
     * @return bool
     */
    public function getPanRemoved()
    {
        return $this->container['pan_removed'];
    }

    /**
     * Sets pan_removed
     *
     * @param bool $pan_removed Indicates if PAN has been removed.
     *
     * @return $this
     */
    public function setPanRemoved($pan_removed)
    {
        $this->container['pan_removed'] = $pan_removed;
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month The expiry month of the card. Currently not available when the Convert API was used before.
     *
     * @return $this
     */
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year The expiry year of the card. Currently not available when the Convert API was used before.
     *
     * @return $this
     */
     ...
     * Gets _3_d
     *
     * @return \Swagger\Client\Model\ThreeDInfo
     */
     ...
     * Sets _3_d
     *
     * @param \Swagger\Client\Model\ThreeDInfo $_3_d _3_d
     *
     * @return $this
     */
