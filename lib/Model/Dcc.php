...
class Dcc implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Dcc';
     ...
     * Sets currency
     *
     * @param string $currency The DCC currency
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param int $amount The DCC amount
     *
     * @return $this
     */
     ...
     * Sets rate
     *
     * @param double $rate The DCC rate
     *
     * @return $this
     */
     ...
     * Sets markup
     *
     * @param double $markup The DCC markup
     *
     * @return $this
     */
