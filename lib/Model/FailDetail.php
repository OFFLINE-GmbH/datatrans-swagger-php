 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FailDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FailDetail';
    ...
    const REASON_SOFT_DECLINED = 'soft_declined';
     ...
     * Sets reason
     *
     * @param string $reason The failure reason if an error occurred.
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message A detailed message describing the occurred error.
     *
     * @return $this
     */
