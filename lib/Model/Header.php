...
class Header implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $public_key_hash Hash of the X.509 encoded public key bytes of the merchant’s certificate.
     *
     * @return $this
     */
     ...
     *
     * @param string $ephemeral_public_key Ephemeral public key bytes. `EC_v1` only.
     *
     * @return $this
     */
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id Transaction identifier, generated on the device.
     *
     * @return $this
     */
