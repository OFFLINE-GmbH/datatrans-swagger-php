...
/**
 * MultiplePartialCapture Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MultiplePartialCapture implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MultiplePartialCapture';
     ...
     *
     * @param int $sequence_number The sequence number of the partial request. It needs to be incremented with every partial request and must not be bigger than the total number.
     *
     * @return $this
     */
     ...
     * Sets total_number
     *
     * @param int $total_number The total number of expected partial settlements. Needs to be set on every partial settlement request.
     *
     * @return $this
     */
