 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MerchantData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MerchantData';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['white_list_status']) && !in_array($this->container['white_list_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'white_list_status', must be one of '%s'",
     ...
     *
     * @param string $white_list_status white_list_status
     *
     * @return $this
     */
