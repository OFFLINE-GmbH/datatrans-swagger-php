...
/**
 * MpgAuthorizeRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MpgAuthorizeRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MpgAuthorizeRequest';
    ...
    {
        $this->container['virtual_card'] = isset($data['virtual_card']) ? $data['virtual_card'] : null;
        $this->container['invoice_on_delivery'] = isset($data['invoice_on_delivery']) ? $data['invoice_on_delivery'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['virtual_card'] === null) {
            $invalidProperties[] = "'virtual_card' can't be null";
        }
    ...
    {
        return $this->container['virtual_card'];
    }

    /**
     * Sets virtual_card
     *
     * @param string $virtual_card The virtual card received from a previous MPA request.
     *
     * @return $this
     */
    public function setVirtualCard($virtual_card)
    {
        $this->container['virtual_card'] = $virtual_card;
     ...
     *
     * @param bool $invoice_on_delivery If set to `true`, The customers bank details (ESR data) are available from the Status API
     *
     * @return $this
     */
