 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ThreeDSRequestor implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ThreeDSRequestor';
    ...
    protected static $swaggerTypes = [
        ...
        'three_ds_requestor_authentication_info' => '\Swagger\Client\Model\ThreeDSRequestorAuthenticationInformation',
    ...
    const THREE_DS_REQUESTOR_CHALLENGE_IND__82 = '82';
    const THREE_DS_REQUESTOR_CHALLENGE_IND__90 = '90';
    ...
    public function getThreeDsRequestorChallengeIndAllowableValues()
    {
        return [
            ...
            self::THREE_DS_REQUESTOR_CHALLENGE_IND__82,
            self::THREE_DS_REQUESTOR_CHALLENGE_IND__90,
        ];
    }
    /**
     * Gets allowable values of the enum
    ...
    {
        $this->container['three_ds_requestor_authentication_ind'] = isset($data['three_ds_requestor_authentication_ind']) ? $data['three_ds_requestor_authentication_ind'] : null;
        ...
        $this->container['three_ds_requestor_challenge_ind'] = isset($data['three_ds_requestor_challenge_ind']) ? $data['three_ds_requestor_challenge_ind'] : null;
        $this->container['three_ds_requestor_dec_req_ind'] = isset($data['three_ds_requestor_dec_req_ind']) ? $data['three_ds_requestor_dec_req_ind'] : null;
        $this->container['three_ds_requestor_dec_max_time'] = isset($data['three_ds_requestor_dec_max_time']) ? $data['three_ds_requestor_dec_max_time'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['three_ds_requestor_authentication_ind']) && !in_array($this->container['three_ds_requestor_authentication_ind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'three_ds_requestor_authentication_ind', must be one of '%s'",
        ...
        if (!is_null($this->container['three_ds_requestor_challenge_ind']) && !in_array($this->container['three_ds_requestor_challenge_ind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'three_ds_requestor_challenge_ind', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
        ...
        if (!is_null($this->container['three_ds_requestor_dec_req_ind']) && !in_array($this->container['three_ds_requestor_dec_req_ind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'three_ds_requestor_dec_req_ind', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string $three_ds_requestor_authentication_ind three_ds_requestor_authentication_ind
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ThreeDSRequestorAuthenticationInformation
     */
     ...
     *
     * @param \Swagger\Client\Model\ThreeDSRequestorAuthenticationInformation $three_ds_requestor_authentication_info three_ds_requestor_authentication_info
     *
     * @return $this
     */
     ...
     *
     * @param string $three_ds_requestor_challenge_ind three_ds_requestor_challenge_ind
     *
     * @return $this
     */
     ...
     *
     * @param string $three_ds_requestor_dec_req_ind three_ds_requestor_dec_req_ind
     *
     * @return $this
     */
     ...
     *
     * @param int $three_ds_requestor_dec_max_time three_ds_requestor_dec_max_time
     *
     * @return $this
     */
