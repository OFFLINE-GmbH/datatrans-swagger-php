 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BuyerMetaData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BuyerMetaData';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_first_time_customer'] = isset($data['is_first_time_customer']) ? $data['is_first_time_customer'] : null;
        $this->container['number_of_past_purchases'] = isset($data['number_of_past_purchases']) ? $data['number_of_past_purchases'] : null;
        $this->container['number_of_disputed_purchases'] = isset($data['number_of_disputed_purchases']) ? $data['number_of_disputed_purchases'] : null;
        $this->container['has_open_dispute'] = isset($data['has_open_dispute']) ? $data['has_open_dispute'] : null;
        $this->container['risk_score'] = isset($data['risk_score']) ? $data['risk_score'] : null;
        $this->container['user_agent'] = isset($data['user_agent']) ? $data['user_agent'] : null;
        $this->container['language'] = isset($data['language']) ? $data['language'] : null;
        $this->container['recipient_email_matches'] = isset($data['recipient_email_matches']) ? $data['recipient_email_matches'] : null;
        $this->container['buyer_is_a_traveler'] = isset($data['buyer_is_a_traveler']) ? $data['buyer_is_a_traveler'] : null;
    }
     ...
     * Sets version
     *
     * @param string $version The version of BuyerMetaData field (used for tracking schema changes to the field).
     *
     * @return $this
     */
     ...
     *
     * @param bool $is_first_time_customer True if the buyer is purchasing from the merchant for the first time. Else false.
     *
     * @return $this
     */
     ...
     *
     * @param int $number_of_past_purchases The number of purchases the buyer has made from the merchant in the past.
     *
     * @return $this
     */
     ...
     *
     * @param int $number_of_disputed_purchases The number of purchases that has been disputed by the buyer when making purchases from the merchant.
     *
     * @return $this
     */
     ...
     *
     * @param bool $has_open_dispute True if the buyer has an ongoing dispute regarding a past purchase.
     *
     * @return $this
     */
     ...
     * Sets risk_score
     *
     * @param string $risk_score The risk score which the merchant computes for a buyer. The value must be a decimal in the range between 0 (lowest risk) and 1 (highest risk).
     *
     * @return $this
     */
     ...
     * Sets user_agent
     *
     * @param string $user_agent The user agent of the browser used by the buyer to make the purchase on merchant site. Example: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36.
     *
     * @return $this
     */
     ...
     * Sets language
     *
     * @param string $language Language in which the buyer is viewing the site at the time of placing the order in 'language-LOCALE' format example: en-US. Use ISO 639-1:2002 code for the language part (en) and ISO 3166-1 alpha-2 for the LOCALE part (US).
     *
     * @return $this
     */
     ...
     *
     * @param bool $recipient_email_matches True, if the recipient email is exactly the same as the one on the amazon account used for payment, false otherwise.
     *
     * @return $this
     */
     ...
     *
     * @param bool $buyer_is_a_traveler True, if the account holder of the amazon account is actually one of the travelers, false otherwise.
     *
     * @return $this
     */
