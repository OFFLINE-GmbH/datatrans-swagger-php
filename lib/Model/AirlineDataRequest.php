 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AirlineDataRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AirlineDataRequest';
     ...
     * Sets country_code
     *
     * @param string $country_code Passenger country code in <a href='https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2' target='_blank'>ISO-3166-1-alpha2</a> format.
     *
     * @return $this
     */
     ...
     * Sets agent_code
     *
     * @param string $agent_code IATA agency code
     *
     * @return $this
     */
     ...
     * Sets issue_date
     *
     * @param \DateTime $issue_date Ticket issuing date. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (`YYYY-MM-DD`).
     *
     * @return $this
     */
     ...
     * Sets tickets
     *
     * @param \Swagger\Client\Model\Ticket[] $tickets A list of tickets for this purchase. Note: PAP only supports one ticket.
     *
     * @return $this
     */
