 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PostfinanceDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PostfinanceDetail';
     ...
     * Sets masked
     *
     * @param string $masked Masked card number. Can be used to display on a users profile page. For example: `****2345`
     *
     * @return $this
     */
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month The expiry month of the Postfinance card
     *
     * @return $this
     */
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year The expiry year of the Postfinance card
     *
     * @return $this
     */
