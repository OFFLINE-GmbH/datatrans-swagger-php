...
/**
 * NetworkTokenInfo Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworkTokenInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NetworkTokenInfo';
    ...
    protected static $swaggerTypes = [
        'token_created' => 'bool',
        'error_details' => '\Swagger\Client\Model\NetworkTokenError'
    ];
    ...
    {
        $this->container['token_created'] = isset($data['token_created']) ? $data['token_created'] : null;
    ...
    {
        return $this->container['token_created'];
    }

    /**
     * Sets token_created
     *
     * @param bool $token_created If a network token was requested then this value informs if it was successfully created or not.
     *
     * @return $this
     */
    public function setTokenCreated($token_created)
    {
        $this->container['token_created'] = $token_created;
     ...
     * Gets error_details
     *
     * @return \Swagger\Client\Model\NetworkTokenError
     */
     ...
     * Sets error_details
     *
     * @param \Swagger\Client\Model\NetworkTokenError $error_details error_details
     *
     * @return $this
     */
