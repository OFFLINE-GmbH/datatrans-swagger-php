...
/**
 * CvvTokenizeResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CvvTokenizeResponse extends TokenizeResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CvvTokenizeResponse';
     ...
     * Sets alias
     *
     * @param string $alias The requested CVV alias. CVV aliases have a limited lifespan of 30 minutes and can't be detokenized anymore when expired.
     *
     * @return $this
     */
     ...
     * Sets expiry_date
     *
     * @param \DateTime $expiry_date The alias expiration date.
     *
     * @return $this
     */
