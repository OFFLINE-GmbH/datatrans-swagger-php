...
/**
 * CvvDetokenizeRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CvvDetokenizeRequest extends DetokenizeRequest 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CvvDetokenizeRequest';
     ...
     * Sets alias
     *
     * @param string $alias A CVV alias received from a previous request. CVV aliases have a limited lifespan of 30 minutes and can't be detokenized anymore when expired.
     *
     * @return $this
     */
