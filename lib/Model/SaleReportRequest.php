 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SaleReportRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SaleReportRequest';
     ...
     * Sets date
     *
     * @param \DateTime $date The date when the transaction happened.
     *
     * @return $this
     */
