 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KlarnaCustomerAccountInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KlarnaCustomerAccountInfo';
     ...
     *
     * @param string $unique_identifier A unique name or number to identify the specific customer account. Max. 24 characters.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $registration_date The registration date and time of the account. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return $this
     */
     ...
     * Sets last_modified
     *
     * @param \DateTime $last_modified The date and time the account was modified the last time. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return $this
     */
