...
class WeChatResponse implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['nonce_string'] = isset($data['nonce_string']) ? $data['nonce_string'] : null;
     ...
     * Sets prepay_id
     *
     * @param string $prepay_id The order prepayId. To be used by the Mini APP in the payment confirmation process.
     *
     * @return $this
     */
     ...
     * Sets nonce_string
     *
     * @param string $nonce_string nonce_string
     *
     * @return $this
     */
