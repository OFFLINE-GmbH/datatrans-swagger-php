 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TwintInitRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TwintInitRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'message_type_id_validity_hours' => 'int',
        'return_app_scheme' => 'string',
        'return_app_package' => 'string'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'message_type_id_validity_hours' => 'int32',
        'return_app_scheme' => null,
        'return_app_package' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'message_type_id_validity_hours' => 'messageTypeIdValidityHours',
        'return_app_scheme' => 'returnAppScheme',
        'return_app_package' => 'returnAppPackage'
    ];
    ...
    protected static $setters = [
        ...
        'message_type_id_validity_hours' => 'setMessageTypeIdValidityHours',
        'return_app_scheme' => 'setReturnAppScheme',
        'return_app_package' => 'setReturnAppPackage'
    ];
    ...
    protected static $getters = [
        ...
        'message_type_id_validity_hours' => 'getMessageTypeIdValidityHours',
        'return_app_scheme' => 'getReturnAppScheme',
        'return_app_package' => 'getReturnAppPackage'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['order_details_url'] = isset($data['order_details_url']) ? $data['order_details_url'] : null;
        $this->container['message_type_id_validity_hours'] = isset($data['message_type_id_validity_hours']) ? $data['message_type_id_validity_hours'] : null;
        $this->container['return_app_scheme'] = isset($data['return_app_scheme']) ? $data['return_app_scheme'] : null;
        $this->container['return_app_package'] = isset($data['return_app_package']) ? $data['return_app_package'] : null;
    }
     ...
     *
     * @param string $order_details_url URL to the order details page, where the merchant displays a summary of the order and/or allows other functionality that is relevant for the use case.
     *
     * @return $this
     */
    ...
    /**
     * Gets message_type_id_validity_hours
     *
     * @return int
     */
    public function getMessageTypeIdValidityHours()
    {
        return $this->container['message_type_id_validity_hours'];
    }

    /**
     * Sets message_type_id_validity_hours
     *
     * @param int $message_type_id_validity_hours Number of hours that messageTypeId (the Spotlight Message identifier provided by TWINT) will be valid. Spotlight message will be displayed during these validity hours.
     *
     * @return $this
     */
    public function setMessageTypeIdValidityHours($message_type_id_validity_hours)
    {
        $this->container['message_type_id_validity_hours'] = $message_type_id_validity_hours;

        return $this;
    }

    /**
     * Gets return_app_scheme
     *
     * @return string
     */
    public function getReturnAppScheme()
    {
        return $this->container['return_app_scheme'];
    }

    /**
     * Sets return_app_scheme
     *
     * @param string $return_app_scheme Parameter which needs to be appended to the URL used in Twint Browser-to-App switch for iOS. For example 'twint-issuer1'.
     *
     * @return $this
     */
    public function setReturnAppScheme($return_app_scheme)
    {
        $this->container['return_app_scheme'] = $return_app_scheme;

        return $this;
    }

    /**
     * Gets return_app_package
     *
     * @return string
     */
    public function getReturnAppPackage()
    {
        return $this->container['return_app_package'];
    }

    /**
     * Sets return_app_package
     *
     * @param string $return_app_package Parameter which needs to be appended to the URL used in Twint Browser-to-App switch for Android. For example 'ch.twint.payment'.
     *
     * @return $this
     */
    public function setReturnAppPackage($return_app_package)
    {
        $this->container['return_app_package'] = $return_app_package;
