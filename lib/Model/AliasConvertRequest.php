 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AliasConvertRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AliasConvertRequest';
    ...
    {
        $this->container['legacy_alias'] = isset($data['legacy_alias']) ? $data['legacy_alias'] : null;
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month The expiry month of the credit card behind alias.
     *
     * @return $this
     */
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year The expiry year of the credit card behind the alias
     *
     * @return $this
     */
