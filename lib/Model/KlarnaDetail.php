 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KlarnaDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KlarnaDetail';
     ...
     * Sets subtype
     *
     * @param string $subtype The Klarna payment subtype. For example 'invoice' or 'direct_bank_transfer' etc.
     *
     * @return $this
     */
