 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ThreeDSRequestorAuthenticationInformation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ThreeDSRequestorAuthenticationInformation';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['three_ds_req_auth_method']) && !in_array($this->container['three_ds_req_auth_method'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'three_ds_req_auth_method', must be one of '%s'",
     ...
     *
     * @param string $three_ds_req_auth_method three_ds_req_auth_method
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $three_ds_req_auth_timestamp three_ds_req_auth_timestamp
     *
     * @return $this
     */
     ...
     *
     * @param string $three_ds_req_auth_data three_ds_req_auth_data
     *
     * @return $this
     */
