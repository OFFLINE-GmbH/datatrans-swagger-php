 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AirlineMetaData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AirlineMetaData';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['airline_code'] = isset($data['airline_code']) ? $data['airline_code'] : null;
        ...
        $this->container['destination_airport'] = isset($data['destination_airport']) ? $data['destination_airport'] : null;
        $this->container['class_of_travel'] = isset($data['class_of_travel']) ? $data['class_of_travel'] : null;
        $this->container['booked_last_time'] = isset($data['booked_last_time']) ? $data['booked_last_time'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['class_of_travel']) && !in_array($this->container['class_of_travel'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'class_of_travel', must be one of '%s'",
     ...
     * Sets version
     *
     * @param string $version The version of AirlineMetaData field (used for tracking schema changes to the field)
     *
     * @return $this
     */
     ...
     * Sets airline_code
     *
     * @param string $airline_code IATA 2-letter airline code. It identifies the carrier. Example: AA (American Airlines)
     *
     * @return $this
     */
     ...
     * Sets flight_date
     *
     * @param \DateTime $flight_date Flight departure date. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`). The time mentioned here is local time
     *
     * @return $this
     */
     ...
     *
     * @param string $departure_airport IATA 3-letter code of the departure airport. Example: CDG
     *
     * @return $this
     */
     ...
     *
     * @param string $destination_airport IATA 3-letter code of the departure airport. Example: LUX
     *
     * @return $this
     */
     ...
     *
     * @param string $class_of_travel travel class identifier.
     *
     * @return $this
     */
     ...
     *
     * @param int $booked_last_time Days since the buyer booked a flight to the same destination last time. Use value -1 if buyer books this destination for the first time.
     *
     * @return $this
     */
     ...
     * Sets passengers
     *
     * @param \Swagger\Client\Model\Passenger $passengers passengers
     *
     * @return $this
     */
