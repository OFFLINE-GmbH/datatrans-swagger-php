...
class Ticket implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['description_code'] = isset($data['description_code']) ? $data['description_code'] : null;
     ...
     * Sets passenger_name
     *
     * @param string $passenger_name Name of passenger or person to whom the ticket was issued
     *
     * @return $this
     */
     ...
     *
     * @param string $description_code Description code
     *
     * @return $this
     */
     ...
     * Sets legs
     *
     * @param \Swagger\Client\Model\Leg[] $legs List of ticket's legs
     *
     * @return $this
     */
