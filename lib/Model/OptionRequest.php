 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OptionRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OptionRequest';
    ...
    {
        $this->container['create_alias'] = isset($data['create_alias']) ? $data['create_alias'] : null;
        $this->container['return_masked_card_number'] = isset($data['return_masked_card_number']) ? $data['return_masked_card_number'] : null;
        $this->container['return_customer_country'] = isset($data['return_customer_country']) ? $data['return_customer_country'] : null;
        ...
        $this->container['return_mobile_token'] = isset($data['return_mobile_token']) ? $data['return_mobile_token'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['remember_me']) && !in_array($this->container['remember_me'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'remember_me', must be one of '%s'",
     ...
     * Sets create_alias
     *
     * @param bool $create_alias Whether an alias should be created for this transaction or not. If set to `true` an alias will be created. This alias can then be used to [initialize](#operation/init) or [authorize](#operation/authorize) a transaction. One possible use case is to charge the card of an existing (registered) cardholder.
     *
     * @return $this
     */
     ...
     *
     * @param bool $return_masked_card_number Whether to return the masked card number. Format: `520000xxxxxx0080`
     *
     * @return $this
     */
     ...
     *
     * @param bool $return_customer_country If set to `true`, the country of the customers issuer will be returned.
     *
     * @return $this
     */
     ...
     *
     * @param bool $authentication_only Whether to only authenticate the transaction (3D process only). If set to `true`, the actual authorization will not take place.
     *
     * @return $this
     */
     ...
     * Sets remember_me
     *
     * @param string $remember_me Whether to show a checkbox on the payment page to let the customer choose if they want to save their card information.
     *
     * @return $this
     */
     ...
     *
     * @param bool $return_mobile_token Indicates that a mobile token should be created. This is needed when using our Mobile SDKs.
     *
     * @return $this
     */
