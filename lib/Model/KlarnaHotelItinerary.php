 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KlarnaHotelItinerary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KlarnaHotelItinerary';
    ...
    protected static $swaggerTypes = [
        'hotel_name' => 'string',
        'address' => '\Swagger\Client\Model\KlarnaAddress',
        'start_time' => '\DateTime',
        'end_time' => '\DateTime',
        'number_of_rooms' => 'int',
        'passenger_id' => 'int[]',
     ...
     * Gets address
     *
     * @return \Swagger\Client\Model\KlarnaAddress
     */
     ...
     * Sets address
     *
     * @param \Swagger\Client\Model\KlarnaAddress $address address
     *
     * @return $this
     */
     ...
     * Sets start_time
     *
     * @param \DateTime $start_time The start date and time of the reservation. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return $this
     */
     ...
     * Sets end_time
     *
     * @param \DateTime $end_time The end date and time of the reservation. Must be in <a href='https://en.wikipedia.org/wiki/ISO_8601' target='_blank'>ISO-8601</a> format (e.g. `YYYY-MM-DDTHH:MM:ss.SSSZ`).
     *
     * @return $this
     */
