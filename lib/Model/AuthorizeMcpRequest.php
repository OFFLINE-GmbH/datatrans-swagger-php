...
/**
 * AuthorizeMcpRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AuthorizeMcpRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthorizeMcpRequest';
     ...
     *
     * @param double $conversion_rate Conversion rate received from the currency rates endpoint. Required in case of dynamic MCP.
     *
     * @return $this
     */
