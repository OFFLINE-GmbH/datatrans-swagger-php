...
class PlainCard extends Card 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlainCard';
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month The expiry month of the credit card.
     *
     * @return $this
     */
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year The expiry year of the credit card.
     *
     * @return $this
     */
