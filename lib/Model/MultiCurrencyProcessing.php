...
/**
 * MultiCurrencyProcessing Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MultiCurrencyProcessing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MultiCurrencyProcessing';
    ...
    protected static $swaggerFormats = [
        ...
        'local_transaction_time' => null,
        'retrieval_reference_number' => null,
        'user_id' => null,
        'provider' => null,
        'reason_indicator' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'user_id' => 'userId',
        'provider' => 'provider',
        'reason_indicator' => 'reasonIndicator'
    ];
    ...
    protected static $setters = [
        ...
        'reason_indicator' => 'setReasonIndicator'
    ];
    ...
    protected static $getters = [
        ...
        'reason_indicator' => 'getReasonIndicator'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reason_indicator'] = isset($data['reason_indicator']) ? $data['reason_indicator'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['local_transaction_time'] === null) {
            $invalidProperties[] = "'local_transaction_time' can't be null";
        }
        if ($this->container['retrieval_reference_number'] === null) {
            $invalidProperties[] = "'retrieval_reference_number' can't be null";
        }
        ...
        if ($this->container['reason_indicator'] === null) {
            $invalidProperties[] = "'reason_indicator' can't be null";
        }
     ...
     *
     * @param double $conversion_rate Conversion rate received from the currency rates endpoint
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param int $amount The amount in your targeted currency
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $transaction_date Transaction datetime received from the currency rates endpoint
     *
     * @return $this
     */
     ...
     *
     * @param string $local_transaction_time LocalTransactionTime received from the currency rates endpoint
     *
     * @return $this
     */
     ...
     *
     * @param string $retrieval_reference_number RetrievalReferenceNumber received from the currency rates endpoint
     *
     * @return $this
     */
     ...
     * Sets provider
     *
     * @param string $provider The provider for multi currency processing
     *
     * @return $this
     */
    ...
    /**
     * Gets reason_indicator
     *
     * @return string
     */
    public function getReasonIndicator()
    {
        return $this->container['reason_indicator'];
    }

    /**
     * Sets reason_indicator
     *
     * @param string $reason_indicator If received from acquirer the reason indicator can be set
     *
     * @return $this
     */
    public function setReasonIndicator($reason_indicator)
    {
        $this->container['reason_indicator'] = $reason_indicator;
