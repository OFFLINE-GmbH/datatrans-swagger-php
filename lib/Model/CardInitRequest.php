 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CardInitRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CardInitRequest';
    ...
    protected static $swaggerTypes = [
        ...
        '_3_d' => '\Swagger\Client\Model\CardInitThreeDSecure'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['create_alias_cvv'] = isset($data['create_alias_cvv']) ? $data['create_alias_cvv'] : null;
     ...
     * Sets number
     *
     * @param string $number Merchants that have the option to store card information on their end can use the `number` property instead of `alias`. Please note that this option is only available to merchants that fulfill the requirements by PCI DSS to store sensitive information on their side and only upon request.
     *
     * @return $this
     */
     ...
     *
     * @param bool $create_alias_cvv Specifies whether a CVV alias should be created
     *
     * @return $this
     */
     ...
     * Gets _3_d
     *
     * @return \Swagger\Client\Model\CardInitThreeDSecure
     */
     ...
     * Sets _3_d
     *
     * @param \Swagger\Client\Model\CardInitThreeDSecure $_3_d _3_d
     *
     * @return $this
     */
