...
/**
 * VippsRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VippsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VippsRequest';
    ...
    protected static $setters = [
        'customer_mobile_number' => 'setCustomerMobileNumber',
        'payment_text' => 'setPaymentText'
    ];
    ...
    protected static $getters = [
        'customer_mobile_number' => 'getCustomerMobileNumber',
        'payment_text' => 'getPaymentText'
    ];
    ...
    {
        $this->container['customer_mobile_number'] = isset($data['customer_mobile_number']) ? $data['customer_mobile_number'] : null;
        $this->container['payment_text'] = isset($data['payment_text']) ? $data['payment_text'] : null;
    }
    ...
    /**
     * Gets customer_mobile_number
     *
     * @return string
     */
    public function getCustomerMobileNumber()
    {
        return $this->container['customer_mobile_number'];
    }

    /**
     * Sets customer_mobile_number
     *
     * @param string $customer_mobile_number Mobile number (eight digits) of the user who has to pay for the transaction from Vipps.
     *
     * @return $this
     */
    public function setCustomerMobileNumber($customer_mobile_number)
    {
        $this->container['customer_mobile_number'] = $customer_mobile_number;
    ...
    {
        return $this->container['payment_text'];
    }

    /**
     * Sets payment_text
     *
     * @param string $payment_text Text to be displayed to end user.
     *
     * @return $this
     */
    public function setPaymentText($payment_text)
    {
        $this->container['payment_text'] = $payment_text;
