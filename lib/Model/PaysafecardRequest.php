 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaysafecardRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaysafecardRequest';
    ...
    {
        $this->container['merchant_client_id'] = isset($data['merchant_client_id']) ? $data['merchant_client_id'] : null;
    }
