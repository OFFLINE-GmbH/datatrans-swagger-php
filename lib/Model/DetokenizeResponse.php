...
/**
 * DetokenizeResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DetokenizeResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DetokenizeResponse';
    ...
    const TYPE_IBAN_ACCOUNT_NUMBER = 'IBAN_ACCOUNT_NUMBER';
    const TYPE_IBAN_BRANCH_CODE = 'IBAN_BRANCH_CODE';
    const TYPE_TWI = 'TWI';
    const TYPE_KLN = 'KLN';
    const TYPE_INT = 'INT';
    const TYPE_PAP = 'PAP';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_REK
            self::TYPE_IBAN
            self::TYPE_IBAN_ACCOUNT_NUMBER
            self::TYPE_IBAN_BRANCH_CODE
            self::TYPE_TWI
            self::TYPE_KLN
            self::TYPE_INT
            self::TYPE_PAP
