 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ThemeConfiguration implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'themeConfiguration';
    ...
    const PAY_BUTTON_TEXT_COLOR_BLACK = 'black';
    const PAY_BUTTON_TEXT_COLOR_WHITE = 'white';
     ...
     * @return string[]
     */
    public function getPayButtonTextColorAllowableValues()
    {
        return [
            self::PAY_BUTTON_TEXT_COLOR_BLACK,
            self::PAY_BUTTON_TEXT_COLOR_WHITE,
        ];
    }
    /**
     * Gets allowable values of the enum
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['logo_border_color'] = isset($data['logo_border_color']) ? $data['logo_border_color'] : null;
        $this->container['brand_button'] = isset($data['brand_button']) ? $data['brand_button'] : null;
        $this->container['pay_button_text_color'] = isset($data['pay_button_text_color']) ? $data['pay_button_text_color'] : null;
        $this->container['logo_src'] = isset($data['logo_src']) ? $data['logo_src'] : null;
        $this->container['initial_view'] = isset($data['initial_view']) ? $data['initial_view'] : null;
        $this->container['brand_title'] = isset($data['brand_title']) ? $data['brand_title'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['text_color']) && !in_array($this->container['text_color'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'text_color', must be one of '%s'",
        ...
        if (!is_null($this->container['logo_type']) && !in_array($this->container['logo_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'logo_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getPayButtonTextColorAllowableValues();
        if (!is_null($this->container['pay_button_text_color']) && !in_array($this->container['pay_button_text_color'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'pay_button_text_color', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
        ...
        if (!is_null($this->container['initial_view']) && !in_array($this->container['initial_view'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'initial_view', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets brand_color
     *
     * @param string $brand_color Hex notation of a color
     *
     * @return $this
     */
     ...
     * Sets text_color
     *
     * @param string $text_color The color of the text in the header bar if no logo is given
     *
     * @return $this
     */
     ...
     * Sets logo_type
     *
     * @param string $logo_type The header logo's display style
     *
     * @return $this
     */
     ...
     *
     * @param string $logo_border_color Decides whether the logo shall be styled with a border around it, if the value is true the default background color is chosen, else the provided string is used as color value
     *
     * @return $this
     */
     ...
     * Sets brand_button
     *
     * @param string $brand_button Decides if the pay button should have the same color as the brandColor. If set to false the hex color #01669F will be used as a default
     *
     * @return $this
     */
     ...
     *
     * @param string $pay_button_text_color The color of the pay button
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getPayButtonTextColorAllowableValues();
        if (!is_null($pay_button_text_color) && !in_array($pay_button_text_color, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'pay_button_text_color', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets logo_src
     *
     * @param string $logo_src An SVG image provided by the merchant. The image needs to be uploaded by using the Datatrans Web Administration Tool
     *
     * @return $this
     */
     ...
     * Sets initial_view
     *
     * @param string $initial_view Wheter the payment page shows the payment method selection as list (default) or as a grid
     *
     * @return $this
     */
     ...
     * Sets brand_title
     *
     * @param bool $brand_title If set to `false` and no logo is used (see `logoSrc`), the payment page header will be empty
     *
     * @return $this
     */
