 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KlarnaArena implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KlarnaArena';
     ...
     * Sets street
     *
     * @param string $street The street of the arena location
     *
     * @return $this
     */
     ...
     * Sets zip_code
     *
     * @param string $zip_code The postal code of the arena location
     *
     * @return $this
     */
     ...
     * Sets city
     *
     * @param string $city The city of the arena location
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param string $country The country of the arena location
     *
     * @return $this
     */
