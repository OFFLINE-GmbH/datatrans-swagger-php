...
/**
 * StatusCardDetail Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StatusCardDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StatusCardDetail';
    ...
    protected static $swaggerTypes = [
        ...
        'expiry_month' => 'string',
        'expiry_year' => 'string',
        'info' => '\Swagger\Client\Model\CardInfo',
        'wallet_indicator' => 'string',
        '_3_d' => '\Swagger\Client\Model\EMVCo3DAuthenticationDataStatusResponse'
    ];
    ...
    const WALLET_INDICATOR_VPS = 'VPS';
    const WALLET_INDICATOR_MBP = 'MBP';
    ...
    public function getWalletIndicatorAllowableValues()
    {
        return [
            ...
            self::WALLET_INDICATOR_VPS,
            self::WALLET_INDICATOR_MBP,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['alias_cvv'] = isset($data['alias_cvv']) ? $data['alias_cvv'] : null;
        ...
        $this->container['wallet_indicator'] = isset($data['wallet_indicator']) ? $data['wallet_indicator'] : null;
        $this->container['_3_d'] = isset($data['_3_d']) ? $data['_3_d'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['wallet_indicator']) && !in_array($this->container['wallet_indicator'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'wallet_indicator', must be one of '%s'",
     ...
     * Sets alias
     *
     * @param string $alias The resulting alias, if requested or available.
     *
     * @return $this
     */
     ...
     * Sets fingerprint
     *
     * @param string $fingerprint An unique identifier of the card number. Useful to identify multiple customers' or the same customer's transactions where the same card was used.
     *
     * @return $this
     */
     ...
     * Sets masked
     *
     * @param string $masked Masked credit card number. Can be used to display on a users profile page. For example: `424242xxxxxx4242`
     *
     * @return $this
     */
     ...
     * Sets alias_cvv
     *
     * @param string $alias_cvv Alias of the CVV. Will be deleted immediately after authorization.
     *
     * @return $this
     */
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month The expiry month of the credit card alias.
     *
     * @return $this
     */
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year The expiry year of the credit card alias
     *
     * @return $this
     */
     ...
     * Sets info
     *
     * @param \Swagger\Client\Model\CardInfo $info info
     *
     * @return $this
     */
     ...
     *
     * @param string $wallet_indicator wallet_indicator
     *
     * @return $this
     */
     ...
     * Gets _3_d
     *
     * @return \Swagger\Client\Model\EMVCo3DAuthenticationDataStatusResponse
     */
     ...
     * Sets _3_d
     *
     * @param \Swagger\Client\Model\EMVCo3DAuthenticationDataStatusResponse $_3_d _3_d
     *
     * @return $this
     */
