 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CancelDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CancelDetail';
     ...
     * Sets reversal
     *
     * @param bool $reversal Whether the transaction was reversed on acquirer side.
     *
     * @return $this
     */
