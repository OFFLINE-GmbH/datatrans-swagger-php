 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MPXDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MPXDetail';
    ...
    protected static $swaggerTypes = [
        ...
        'esr' => '\Swagger\Client\Model\EsrData',
        'qr_data' => '\Swagger\Client\Model\QrData'
    ];
    ...
    protected static $setters = [
        'alias' => 'setAlias',
        'paycard_number' => 'setPaycardNumber',
        'esr' => 'setEsr',
        'qr_data' => 'setQrData'
    ];
    ...
    protected static $getters = [
        'alias' => 'getAlias',
        'paycard_number' => 'getPaycardNumber',
        'esr' => 'getEsr',
        'qr_data' => 'getQrData'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['paycard_number'] = isset($data['paycard_number']) ? $data['paycard_number'] : null;
        $this->container['esr'] = isset($data['esr']) ? $data['esr'] : null;
        $this->container['qr_data'] = isset($data['qr_data']) ? $data['qr_data'] : null;
    }
     ...
     * @return string
     */
    public function getPaycardNumber()
    {
        return $this->container['paycard_number'];
    }

    /**
     * Sets paycard_number
     *
     * @param string $paycard_number the paycardNumber if available
     *
     * @return $this
     */
    public function setPaycardNumber($paycard_number)
    {
        $this->container['paycard_number'] = $paycard_number;
     ...
     * Gets esr
     *
     * @return \Swagger\Client\Model\EsrData
     */
     ...
     * Sets esr
     *
     * @param \Swagger\Client\Model\EsrData $esr esr
     *
     * @return $this
     */
     ...
     * Gets qr_data
     *
     * @return \Swagger\Client\Model\QrData
     */
    public function getQrData()
    {
        return $this->container['qr_data'];
    }

    /**
     * Sets qr_data
     *
     * @param \Swagger\Client\Model\QrData $qr_data qr_data
     *
     * @return $this
     */
    public function setQrData($qr_data)
    {
        $this->container['qr_data'] = $qr_data;
